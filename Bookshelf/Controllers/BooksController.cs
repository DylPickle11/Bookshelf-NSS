...
namespace Bookshelf.Controllers
{
    ...
    public class BooksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,AuthorId,YearPublished,Rating,GenreId,ApplicationUserId,Genre")] Book book)
        {
            //Who is the user making the book
            var user = await GetCurrentUserAsync();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,AuthorId,YearPublished,Rating,GenreId,ApplicationUserId,Genre")] Book book)
        {
            if (id != book.Id)
            {
                return NotFound();
